<header id="header">
    <?php include("./components/header/components/navbar.php") ?>
    ...
    <div class="header__wrapper">
        ...
        <div class="header__image">
            <img src="./assets/resources/images/header_browser.png" alt="Browser image" onerror="this.style.display = 'none'">
        </div>
    </div>
</header>